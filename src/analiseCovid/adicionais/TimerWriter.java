...
public class TimerWriter {
    ...
    public static void writeTime(Timer timer, String caminhoParaSalvar) {
        try {
            ...
            writer.append(makeString(timer.quickMedTimeObitos, "QuickSort Mediana de Tres", OBITOS));
            writer.append(makeString(timer.quickMedTimeCasos, "QuickSort Mediana de Tres", CASOS));
            writer.append(makeString(timer.quickMedTimeCidades, "QuickSort Mediana de Tres", CIDADES));
    ...
    private static String makeString(long[] times, String algorithmName, String orderType) {
        ...
        builder.append("Medio Caso - " + orderType + ": " + times[Timer.MEDIO] + "\n");
